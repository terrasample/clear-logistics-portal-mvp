...
const HOME_CATEGORY_TILES = [
  ...
  },
  {
    ...
    image: '/catalog/section_pages/orig-p024-i5.jpeg',
    category: 'Outdoor Kitchens',
    description: 'Grills, prep stations, and backyard cooking setups.',
    priceLabel: 'From US$430',
  },
  {
    title: 'Appliances',
    image: '/catalog/section_pages/orig-p087-i2.jpeg',
    category: 'Appliances',
  ...
  },
  {
    ...
    image: '/catalog/section_pages/orig-p094-i1.jpeg',
    category: 'Restaurant Equipment',
    description: 'Commercial cooking and prep equipment for food service.',
    priceLabel: 'From US$1,340',
  },
  {
    title: 'Building Materials',
    image: '/catalog/section_pages/orig-p009-i2.jpeg',
    category: 'Building Materials',
    description: 'Lumber, fixtures, and construction supply bundles.',
  ...
  },
  {
    ...
    image: '/catalog/section_pages/orig-p019-i2.jpeg',
    category: 'Auto & Parts',
    description: 'Parts, accessories, and wheels shipped to Jamaica.',
    priceLabel: 'From US$165',
  },
];
...
const BEDROOM_NON_BED_IMAGE_PATHS = new Set([
  ...
  '/catalog/section_pages/cat1-p053-i1.jpeg',
...
const BEDROOM_SET_HERO_IMAGE_PATHS = new Map([
  ...
  ['MODEL-2158', '/catalog/section_pages/cat1-p049-i2.jpeg'],
  ['MODEL-2161', '/catalog/section_pages/cat1-p060-i4.jpeg'],
  ['MODEL-2162', '/catalog/section_pages/cat1-p059-i1.jpeg'],
  ...
  ['MODEL-2013', '/catalog/section_pages/orig-p058-i2.jpeg'],
  ['MODEL-2014', '/catalog/section_pages/orig-p059-i2.jpeg'],
  ['MODEL-2015', '/catalog/section_pages/orig-p060-i2.jpeg'],
  ['MODEL-2016', '/catalog/section_pages/orig-p061-i2.jpeg'],
  ['MODEL-2017', '/catalog/section_pages/orig-p062-i2.jpeg'],
  ['MODEL-2018', '/catalog/section_pages/orig-p063-i2.jpeg'],
  ['MODEL-2019', '/catalog/section_pages/orig-p064-i2.jpeg'],
  ['MODEL-2020', '/catalog/section_pages/orig-p065-i2.jpeg'],
  ['MODEL-2021', '/catalog/section_pages/orig-p066-i2.jpeg'],
  ['MODEL-2022', '/catalog/section_pages/orig-p067-i2.jpeg'],
  ...
  ['MODEL-2030', '/catalog/section_pages/orig-p075-i2.jpeg'],
  ['MODEL-2031', '/catalog/section_pages/orig-p076-i2.jpeg'],
  ['MODEL-2032', '/catalog/section_pages/orig-p077-i2.jpeg'],
  ['MODEL-2033', '/catalog/section_pages/orig-p078-i2.jpeg'],
  ['MODEL-2034', '/catalog/section_pages/orig-p079-i2.jpeg'],
  ['MODEL-2035', '/catalog/section_pages/orig-p080-i2.jpeg'],
  ...
  function BookingPage() {
    ...
    const bookingStepGuides = {
      1: {
        ...
        summary: 'Tell us where and when to pick up your items.',
        points: [
          ['Contact info', 'Use a phone and email you check often.'],
          ['Pickup address', 'Enter full street address, city, and ZIP.'],
          ['Pickup date', 'Choose your preferred pickup day.'],
        ],
        note: 'Tip: accurate contact details help us reach you quickly.',
      },
      2: {
      ...
      3: {
        ...
        summary: 'Enter who will receive the shipment in Jamaica and where it should go.',
        points: [
          ['Recipient name', 'Add the full name of the receiver.'],
          ['Delivery address', 'Enter the full street delivery address.'],
          ['Parish', 'Choose the correct parish and area.'],
        ],
      ...
      5: {
        ...
        points: [
          ['Shipment ID', 'Save this for tracking and support.'],
          ['QR code', 'Have this ready when the driver arrives.'],
          ['Payment', 'Complete payment to finalize your booking.'],
        ],
        note: 'Tip: after payment, track progress from your dashboard.',
      },
    };
          ...
          {recentQuotes.length === 0 ? (
            ...
            <div style={{ display: 'grid', gap: '0.85rem' }}>
              {recentQuotes.map((quote) => {
                const isSelected = selectedDashboardQuoteId === quote.quoteId;
                ...
                return (
                  <article
                    ...
                    style={{
                      cursor: 'pointer',
                      border: isSelected ? '1px solid rgba(11, 107, 97, 0.42)' : undefined,
                      boxShadow: isSelected ? '0 10px 24px rgba(11, 107, 97, 0.12)' : undefined,
                    }}
                    onClick={() => setSelectedDashboardQuoteId((current) => (current === quote.quoteId ? '' : quote.quoteId))}
                    onKeyDown={(event) => {
                      if (event.key === 'Enter' || event.key === ' ') {
                        event.preventDefault();
                        setSelectedDashboardQuoteId((current) => (current === quote.quoteId ? '' : quote.quoteId));
                      }
                    }}
                  ...
                  >
                    ...
                    {isSelected ? (
                      <section
                        ...
                        aria-live="polite"
                      >
                        <h3 style={{ marginTop: 0, marginBottom: '0.45rem' }}>Quote Details: {quote.quoteId}</h3>
                        <p style={{ margin: '0.2rem 0' }}><strong>Route:</strong> {quote.origin} to {quote.destination}</p>
                        <p style={{ margin: '0.2rem 0' }}><strong>Cargo:</strong> {quote.cargoType}</p>
                        <p style={{ margin: '0.2rem 0' }}><strong>Delivery Parish:</strong> {quote.deliveryParish || 'N/A'}</p>
                        <p style={{ margin: '0.2rem 0' }}><strong>Status:</strong> {quote.status || 'Submitted'}</p>
                        <p style={{ margin: '0.2rem 0' }}><strong>Submitted:</strong> {quote.createdAt ? new Date(quote.createdAt).toLocaleString() : 'N/A'}</p>

                        {Number.isFinite(Number(quote.quotedPriceUsd)) ? (
                          <p style={{ margin: '0.2rem 0' }}><strong>Quoted Price:</strong> ${Number(quote.quotedPriceUsd).toFixed(2)}</p>
                        ) : quote.estimatedRangeUsd ? (
                          <p style={{ margin: '0.2rem 0' }}><strong>Estimated Range:</strong> ${Number(quote.estimatedRangeUsd.low || 0).toFixed(2)} - ${Number(quote.estimatedRangeUsd.high || 0).toFixed(2)}</p>
                        ) : (
                          <p style={{ margin: '0.2rem 0' }}><strong>Pricing:</strong> Pending</p>
                        )}

                        {quote.deliveryZone?.label ? (
                          <p style={{ margin: '0.2rem 0' }}><strong>Delivery Zone:</strong> {quote.deliveryZone.label}</p>
                        ) : null}
                        {quote.spaceTierLabel ? (
                          <p style={{ margin: '0.2rem 0' }}><strong>Space Tier:</strong> {quote.spaceTierLabel}</p>
                        ) : null}
                        ...
                        {quote.pricingBreakdown ? (
                          <details style={{ marginTop: '0.5rem' }}>
                            ...
                            <ul style={{ margin: '0.45rem 0 0', paddingLeft: '1.1rem', lineHeight: 1.6 }}>
                              <li>Strategy: {quote.pricingBreakdown.strategy || 'n/a'}</li>
                              <li>Billable space: {Number(quote.pricingBreakdown.billableCubicFeet || 0).toFixed(2)} cu ft</li>
                              <li>Weight: {Number(quote.pricingBreakdown.weightLbs || 0).toFixed(2)} lbs</li>
                              <li>Selected base: ${Number(quote.pricingBreakdown?.chargesUsd?.selectedBase || 0).toFixed(2)}</li>
                              <li>Delivery fee: ${Number(quote.pricingBreakdown?.chargesUsd?.deliveryZoneFee || 0).toFixed(2)}</li>
                            </ul>
                          </details>
                        ) : null}
                      </section>
